...
-(void)setColor:(int) k{
    ...
    UInt8 G[] = {0xFF,0xFF, 0x52,0x5A, 0xFF,0xFF, 0x1A,0x1D, 0xEF,0xC6, 0xDB,0x89, 0x87,0x0B, 0xFF,0xFF, };
    UInt8 B[] = {0x5E,0x2A, 0xED,0xC8, 0xDB,0xCD, 0xD6,0x62, 0x4D,0x43, 0xDD,0x8C, 0xFC,0xD3, 0x95,0x5E, };
    UInt8 R[] = {0x3A,0x68, 0xC7,0xFB, 0x4C,0x02, 0xFD,0xF0, 0xB6,0xFC, 0xDE,0x90, 0x70,0x18, 0x00,0x3A, };
    ...
    for(int i = 0; i < kGraphMaxSize; i++) {
        ...
        colors[i] = GLKVector4Make(r,g,b,0.0); // set color
    }
